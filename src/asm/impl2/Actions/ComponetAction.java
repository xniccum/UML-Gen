 ...
 */
public class ComponetAction implements IAction{
    private String targetClass;

    public ComponetAction(String targetClass) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ComponetAction)) return false;

        ComponetAction that = (ComponetAction) o;
